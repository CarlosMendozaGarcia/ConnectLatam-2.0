...
export const accounts: Account[] = [
    {
        name: "Engene Colombia",
        socialMedias: [{ name: "TikTok", user: "@engenecolombia" }, { name: "Instagram", user: "@engenecolombia" }],
        logo: "/logos/EngeneColombia.svg"
    ...
    {
        name:"Enhypen Ecuador",
        socialMedias: [{name:"Instagram", user:"@Enhypen_ecuu"}],
        logo:"/logos/EnhypenEC.webp"
    },
    {
        name:"Enhypen Mexico",
        socialMedias: [{name:"X", user:"@ENHYPENMXCO"},{name:"Instagram", user:"@enhypenmexico"}],
        logo:"/logos/EnhypenMexico.png"
    },
    {
        name:"Enhypen Still",
        socialMedias: [{name:"Instagram", user:"@enhypenvnzl"}],
        logo:"/logos/EnhypenStill.png"
    }
]